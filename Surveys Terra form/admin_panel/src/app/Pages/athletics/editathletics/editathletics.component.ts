...
@Component({
  selector: 'app-editathletics',
  templateUrl: './editathletics.component.html',
  styleUrls: ['./editathletics.component.css']
})
export class EditathleticsComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        this.adminService.updateathletics(this.data._id,payload)
          .subscribe((res: any) => {
