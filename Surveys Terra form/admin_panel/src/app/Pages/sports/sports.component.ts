...
import { EditsportsComponent } from './editsports/editsports.component';
...
export class SportsComponent {
  ...
  edit(data: any) {
    ...
    const dialogRef = this.dialog.open(EditsportsComponent, {
      width: '500px',
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(AddsportsComponent, {
      width: '500px',
  ...
  getsports() {
    ...
    try {
      this.adminService.getsports().subscribe((res: any) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          this.adminService.removesports(element._id, {})
            .subscribe((res: any) => {
              setTimeout(() => {
                Swal.fire(
