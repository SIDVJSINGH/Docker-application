...
import { EditraceComponent } from './editrace/editrace.component';
...
export class RaceComponent {
  ...
  edit(data: any) {
    ...
    const dialogRef = this.dialog.open(EditraceComponent, {
      width: '500px',
  ...
  getrace() {
    ...
    try {
      this.adminService.getrace().subscribe((res: any) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          this.adminService.removerace(element._id, {})
            .subscribe((res: any) => {
              setTimeout(() => {
                Swal.fire(
