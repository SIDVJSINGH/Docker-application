...
@Component({
  selector: 'app-addethnicity',
  templateUrl: './addethnicity.component.html',
  styleUrls: ['./addethnicity.component.css']
})
export class AddethnicityComponent implements OnInit {
  ...
  onSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        this.adminService.addEthnicity(payload)
          .subscribe((res: any) => {
