...
@Component({
  selector: 'app-editethnicity',
  templateUrl: './editethnicity.component.html',
  styleUrls: ['./editethnicity.component.css']
})
  ...
  onSubmit(): void {
    ...
    if (this.form.valid) {
      ...
      try {
        ...
        this.adminService.updateEthnicity(this.data._id,payload)
          .subscribe((res: any) => {
