...
import { AddethnicityComponent } from './addethnicity/addethnicity.component';
import { EditethnicityComponent } from './editethnicity/editethnicity.component';


@Component({
  selector: 'app-ethniity',
  templateUrl: './ethniity.component.html',
  styleUrls: ['./ethniity.component.css']
})
export class EthniityComponent {
  ...
  edit(data: any) {
    ...
    const dialogRef = this.dialog.open(EditethnicityComponent, {
      width: '500px',
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(AddethnicityComponent, {
      width: '500px',
  ...
  getrace() {
    ...
    try {
      this.adminService.getEthnicity().subscribe((res: any) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        try {
          ...
          this.adminService.removeEthnicity(element._id, {})
            .subscribe((res: any) => {
              setTimeout(() => {
                Swal.fire(
